...
QUESTIONS.farmer = {
  history: [
    // --- 已保留原有6题 ---
    { subject:'化学', text:'1950年《土地改革法》颁布，你分到几亩田。可庄稼叶片发黄、植株矮小，老农说缺肥。关于氮肥及其使用，下列说法正确的是？', choices:[{text:'尿素[CO(NH₂)₂]是常用氮肥，含氮量约46.7%，氮元素主要促进叶片生长与叶绿素合成',correct:true,knowledge:'化学·氮肥：尿素含氮量高达46.7%，在土壤中经脲酶作用水解为NH₄⁺被植物吸收。'},{text:'铵态氮肥（如NH₄HCO₃）可与草木灰（主成分K₂CO₃）混合施用以增强肥效',correct:false},{text:'检验土壤中NH₄⁺：取样加浓NaOH加热，用湿润红色石蕊试纸检验气体，试纸变蓝则含NH₄⁺',correct:true,knowledge:'化学·离子检验：NH₄⁺+OH⁻→(加热)NH₃↑+H₂O，NH₃使红色石蕊试纸变蓝。'},{text:'氮肥施用越多越好，可大幅提高产量且无任何环境危害',correct:false}] },
    { subject:'化学', text:'土改分田后，你发现自家田因长期渍水呈强酸性（pH≈4.5），村里用生石灰改良。关于土壤酸碱调节，以下说法正确的是？', choices:[{text:'生石灰改良酸性土壤原理：CaO+H₂O=Ca(OH)₂，生成的OH⁻中和土壤中H⁺使pH升高',correct:true,knowledge:'化学·酸碱中和：CaO+H₂O=Ca(OH)₂，Ca(OH)₂+2H⁺=Ca²⁺+2H₂O。'},{text:'若耕层土壤约1.5×10⁵kg，缓冲容量0.1mol·kg⁻¹，pH从4.5升至6.5约需CaO 420 kg',correct:true},{text:'NaOH碱性比Ca(OH)₂更强，改良酸性土壤效果更好且更经济实惠',correct:false},{text:'酸性土壤也可施用石膏（CaSO₄）来调节，其原理与生石灰相同',correct:false}] },
    ...
    // --- 新增化学题 ---
    { subject:'化学', text:'土改后你开始用草木灰（主要成分K₂CO₃）作钾肥。K₂CO₃溶于水后溶液呈碱性，原因是？', choices:[{text:'CO₃²⁻发生水解：CO₃²⁻+H₂O⇌HCO₃⁻+OH⁻，产生OH⁻使溶液呈碱性',correct:true,knowledge:'化学·盐类水解（沪教版·电解质溶液）：强碱弱酸盐中弱酸根离子水解产生OH⁻。'},{text:'K⁺与水反应生成KOH',correct:false},{text:'K₂CO₃直接释放出OH⁻',correct:false},{text:'空气中的CO₂溶解入水生成碳酸',correct:false}] },
    { subject:'化学', text:'村里用铁锅熬制土盐（NaCl），但盐中混有MgCl₂和CaCl₂导致容易潮解。如何用化学方法初步检验Mg²⁺？', choices:[{text:'加入NaOH溶液，产生白色沉淀：Mg²⁺+2OH⁻→Mg(OH)₂↓',correct:true,knowledge:'化学·离子检验（沪教版）：Mg²⁺遇OH⁻产生白色沉淀，此沉淀不溶于过量NaOH。'},{text:'加入AgNO₃溶液看是否产生沉淀',correct:false},{text:'点燃后观察焰色反应',correct:false},{text:'加热至高温观察分解产物',correct:false}] },
    { subject:'化学', text:'农忙时节，你发现铁质农具极易生锈（Fe₂O₃·xH₂O）。关于铁的腐蚀与防护，以下说法正确的是？', choices:[{text:'铁生锈本质上是铁发生电化学腐蚀，Fe作负极发生氧化：Fe-2e⁻→Fe²⁺',correct:true,knowledge:'化学·电化学腐蚀（沪教版·氧化还原）：铁在中性/弱酸性溶液中发生吸氧腐蚀，Fe作负极被氧化。'},{text:'在铁表面镀锌（镀层破损后铁仍受保护）利用了牺牲阳极的阴极保护法，但原理不同',correct:false},{text:'铁生锈属于化学腐蚀，与电化学无关',correct:false},{text:'防止铁生锈的最佳方法是定期用水冲洗表面',correct:false}] },
    ...
    { subject:'政治', text:'1956年三大改造基本完成后，我国确立了社会主义基本制度。这一变革遵循了唯物辩证法的什么原理？', choices:[{text:'生产关系一定要适合生产力状况的规律——对农业、手工业、资本主义工商业的改造适应了当时生产力水平',correct:true,knowledge:'政治·哲学（沪教版·唯物史观）：生产力决定生产关系，生产关系反作用于生产力。三大改造是我国社会生产关系的一次伟大变革。'},{text:'否定之否定规律',correct:false},{text:'对立统一规律',correct:false},{text:'量变质变规律',correct:false}] },
    // --- 新增多选 ---
  ...
  modern: [
    ...
    { subject:'化学', text:'你买了NH₄HCO₃（碳铵）做追肥，也想撒些草木灰（K₂CO₃）补钾。农技员提醒不能混用。下列说法正确的是？', choices:[{text:'反应本质是NH₄⁺与草木灰水解产生的OH⁻反应放出NH₃，导致氮肥失效',correct:true,knowledge:'化学·铵盐性质：NH₄⁺+OH⁻=NH₃↑+H₂O，铵态氮肥不能与碱性物质混用。'},{text:'除K₂CO₃外，Ca(OH)₂、CaO等碱性物质同样不能与铵态氮肥混用，原理相同',correct:true},{text:'NH₄HCO₃与K₂CO₃混合时发生反应：2NH₄HCO₃+K₂CO₃→2NH₃↑+2CO₂↑+2H₂O+K₂CO₃',correct:false},{text:'若将100g NH₄HCO₃（M=79）与足量K₂CO₃混合加热，标准状况下最多损失约28.4L NH₃',correct:true}] },
    ...
    { subject:'化学', text:'为检测某化肥中NH₄⁺含量，取样加过量浓NaOH溶液加热，产生的气体用标准H₂SO₄溶液吸收。涉及的反应类型是？', choices:[{text:'NH₄⁺+OH⁻→(加热)NH₃↑+H₂O是复分解反应；2NH₃+H₂SO₄→(NH₄)₂SO₄是化合反应',correct:true,knowledge:'化学·反应类型（沪教版）：四个基本反应类型——化合、分解、置换、复分解。酸碱中和反应属于复分解反应。'},{text:'整个过程中只涉及中和反应',correct:false},{text:'NH₃的吸收属于氧化还原反应',correct:false},{text:'加热NH₄Cl和NaOH涉及分解反应',correct:false}] },
    ...
    // --- 新增政治题 ---
    { subject:'政治', text:'2013年党的十八届三中全会提出"使市场在资源配置中起决定性作用"。这体现了什么经济学原理？', choices:[{text:'市场通过价格、供求、竞争三大机制实现资源优化配置，但需要政府更好地发挥宏观调控作用',correct:true,knowledge:'政治·经济（沪教版·社会主义市场经济）：市场决定资源配置是市场经济的一般规律，同时需要科学的宏观调控弥补市场失灵。'},{text:'政府不再干预经济',correct:false},{text:'所有领域都由市场自行调节',correct:false},{text:'回到完全的计划经济体制',correct:false}] },
    { subject:'政治', text:'2020年我国脱贫攻坚战取得全面胜利。从唯物辩证法角度看，精准扶贫"精准"二字体现了什么哲学原理？', choices:[{text:'具体问题具体分析——矛盾具有特殊性，不同贫困地区的致贫原因和脱贫路径各不相同',correct:true,knowledge:'政治·哲学（沪教版·矛盾特殊性）：矛盾的特殊性原理要求我们具体问题具体分析，一把钥匙开一把锁。'},{text:'主要矛盾决定次要矛盾',correct:false},{text:'量变必然引起质变',correct:false},{text:'内因决定外因',correct:false}] },
    ...
    // --- 新增多选 ---
    { subject:'化学', multi:true, text:'【多选】你发现连年施用单一化肥后土壤出现板结。以下关于化肥使用与土壤保护的说法正确的有？', choices:[{text:'过量施用化肥特别是铵态氮肥会导致土壤酸化、板结和微生物多样性下降',correct:true,knowledge:'化学·环境化学：过量施用化肥破坏土壤结构，降低土壤缓冲能力，导致土壤退化。'},{text:'测土配方施肥通过科学测定土壤养分含量，按需配比N、P、K肥，减少浪费和污染',correct:true,knowledge:'化学·农业化学：测土配方施肥是精准农业的核心环节，兼顾产量和环保。'},{text:'化肥施用量越大作物产量越高，不存在上限',correct:false},{text:'有机肥可以完全替代化肥，两者作用完全相同',correct:false}] }
  ],
  cyberpunk: [
    // --- 已保留原有6题 ---
    { subject:'化学', text:'1990年代科技兴农，村里建了蔬菜大棚。为增产需增施CO₂气肥，用稀H₂SO₄与NH₄HCO₃反应制备。下列说法正确的是？', choices:[{text:'反应方程式：2NH₄HCO₃+H₂SO₄→(NH₄)₂SO₄+2CO₂↑+2H₂O，同时生成氮肥(NH₄)₂SO₄',correct:true,knowledge:'化学·气肥：一举两得——既产生CO₂促进光合作用，又得到硫酸铵作氮肥。'},{text:'用500g NH₄HCO₃与足量稀硫酸反应，标况下可产生约142L CO₂气体',correct:true},{text:'也可用CaCO₃与稀盐酸反应制备CO₂，反应为CaCO₃+2HCl=CaCl₂+CO₂↑+H₂O',correct:true},{text:'CO₂浓度越高光合作用越强，因此大棚CO₂气肥浓度越高越好，无需控制',correct:false}] },
    ...
    // --- 新增化学题 ---
    { subject:'化学', text:'垂直农业使用营养液栽培，需精确控制Zn²⁺、Cu²⁺等微量元素浓度。当两种离子共存且浓度相近时，如何分离？', choices:[{text:'调节pH使Zn²⁺以Zn(OH)₂沉淀（完全沉淀pH≈8），Cu²⁺以Cu(OH)₂沉淀（完全沉淀pH≈6.5），利用分步沉淀法分离',correct:true,knowledge:'化学·沉淀溶解平衡（沪教版·等级考）：不同金属离子开始沉淀和完全沉淀的pH不同，可通过控制pH实现分离。'},{text:'加入过量NH₃·H₂O使两者都生成配离子',correct:false},{text:'加热蒸发使溶质析出',correct:false},{text:'两者无法用沉淀法分离',correct:false}] },
    { subject:'化学', text:'未来农业使用有机合成技术生产生物降解地膜（聚乳酸PLA）。关于PLA的说法正确的是？', choices:[{text:'PLA由乳酸[CH₃CH(OH)COOH]通过缩聚反应制得——乳酸分子中的-COOH与-OH脱水形成酯基',correct:true,knowledge:'化学·有机高分子（沪教版·有机化学）：缩聚反应即单体通过官能团缩合生成高聚物同时脱去小分子。PLA的酯基可水解。'},{text:'PLA属于加聚产物',correct:false},{text:'PLA在自然界中不能被降解',correct:false},{text:'PLA由乙烯聚合而成',correct:false}] },
    { subject:'化学', text:'基因编辑作物（GMO）的检测中用到PCR技术，需要Taq DNA聚合酶在高温下催化DNA合成。下列关于催化剂和反应速率的描述正确的是？', choices:[{text:'酶作为生物催化剂，通过降低反应活化能来加快反应速率，但其本身在反应前后质量和化学性质不变',correct:true,knowledge:'化学·化学反应速率（沪教版）：催化剂通过改变反应路径降低活化能，Ea↓ → 有效碰撞比例↑ → v↑。自身不参与净反应。'},{text:'酶通过提高反应的ΔH使速率增加',correct:false},{text:'酶在反应后质量减少',correct:false},{text:'温度越低酶催化效率越高',correct:false}] },
    ...
    // --- 新增政治题 ---
    { subject:'政治', text:'【多选】在碳达峰碳中和背景下，"绿水青山就是金山银山"理念体现的哲理有（　）', multi:true, choices:[{text:'人与自然和谐共生——尊重自然规律的客观性',correct:true,knowledge:'政治·哲学（沪教版·唯物论）：自然规律是客观的，不以人的意志为转移，人必须按客观规律办事。'},{text:'保护生态环境就是保护生产力——矛盾双方在一定条件下相互转化',correct:true,knowledge:'政治·哲学（沪教版·矛盾观）：绿水青山（保护）与金山银山（发展）从表面对立走向内在统一。'},{text:'经济价值可以完全脱离自然规律创造',correct:false},{text:'人的主观能动性可以超越一切自然规律',correct:false}] },
    ...
    // --- 新增多选 ---
    { subject:'化学', multi:true, text:'【多选】赛博农场引入AI精准灌溉系统后，需评估水质对作物影响。以下关于水化学性质的说法正确的有？', choices:[{text:'水的硬度由Ca²⁺和Mg²⁺含量决定，硬水灌溉长期可能导致土壤板结和盐渍化',correct:true,knowledge:'化学·水质分析：水的硬度分为暂时硬度（碳酸氢盐）和永久硬度（硫酸盐/氯化物）。'},{text:'灌溉水的pH过高或过低会影响土壤中养分的有效性和微生物活性',correct:true,knowledge:'化学·溶液pH：pH影响土壤中矿物质元素的存在形态和植物根系吸收效率。'},{text:'所有地下水都是纯净的水，不含任何矿物质',correct:false},{text:'水中的溶解氧含量与灌溉水质完全无关',correct:false}] }
  ]
};
...
QUESTIONS.journalist = {
  history: [
    { subject:'语文', text:'1950年代《人民日报》发表了一篇关于农村合作社的通讯稿。这篇稿件最可能采用的文体是？', choices:[{text:'消息——简洁报道事实，用倒金字塔结构',correct:true,knowledge:'语文·新闻文体：消息是最基本的新闻体裁，一般采用"倒金字塔"结构，最重要的信息放在最前面。'},{text:'散文——抒发作者感情，注重文学性',correct:false},{text:'小说——虚构人物情节，追求艺术真实',correct:false},{text:'诗歌——运用意象韵律，表达主观情感',correct:false}] },
    { subject:'语文', text:'1956年国务院发布《汉字简化方案》。以下关于汉字简化的说法正确的是？', choices:[{text:'简化原则包括"述而不作"——尽量采用已经在民间流行的简化字',correct:true,knowledge:'语文·汉字简化：简化字主要来源于历代书法家的简写和民间俗字。"述而不作"就是不凭空造字。'},{text:'简化后所有汉字的笔画数都不超过10画',correct:false},{text:'简化字与繁体字之间是一一对应的关系',correct:false},{text:'《简化字总表》共简化了5000多个汉字',correct:false}] },
    ...
    { subject:'英语', text:'你在一篇关于中国经济发展的英文报道中写道："The reform and opening-up policy ________ tremendous changes to China." 最合适的动词是？', choices:[{text:'brought about（带来、导致）',correct:true,knowledge:'英语·动词搭配："bring about"意为"带来、引起（变化）"，是正式新闻报道中常用的短语动词。'},{text:'brought up',correct:false},{text:'brought in',correct:false},{text:'brought out',correct:false}] },
    ...
    // --- 新增语文题 ---
    { subject:'语文', text:'你采访了一位经历过长征的老红军，需要在报道中引用毛泽东《七律·长征》的名句。以下哪句出自该诗？', choices:[{text:'"红军不怕远征难，万水千山只等闲"——全诗首联，总领全篇，表现红军无畏气概',correct:true,knowledge:'语文·诗歌鉴赏（沪教版·必修）：毛泽东《七律·长征》是高一必修篇目，颔联"五岭逶迤腾细浪，乌蒙磅礴走泥丸"运用夸张和比喻。'},{text:'"钟山风雨起苍黄，百万雄师过大江"',correct:false},{text:'"雄关漫道真如铁，而今迈步从头越"',correct:false},{text:'"天若有情天亦老，人间正道是沧桑"',correct:false}] },
    { subject:'语文', text:'你在整理一份老报纸，发现一篇社论中用了成语"差强人意"。这个成语的意思是？', choices:[{text:'大体上还能使人满意（差：稍微）',correct:true,knowledge:'语文·成语（沪教版·语言运用）：差强人意出自《后汉书》，"差"意为"稍微、大致"，常被误解为"令人不满意"。'},{text:'完全不能令人满意',correct:false},{text:'比别人差很多',correct:false},{text:'强迫别人接受',correct:false}] },
    { subject:'语文', text:'报道中引用鲁迅名言："横眉冷对千夫指，俯首甘为孺子牛。"这句运用了什么修辞手法？', choices:[{text:'对偶——上下句字数相等、结构相同、意义相关，形成鲜明对比',correct:true,knowledge:'语文·修辞（沪教版）：对偶是用字数相等、结构相同、意义对称的一对句子来表达两个相对或相近的意思。鲁迅此联堪称对偶典范。'},{text:'排比',correct:false},{text:'反复',correct:false},{text:'设问',correct:false}] },
    ...
    // --- 新增英语题 ---
    { subject:'英语', text:'1950年代，你第一次读到《China Daily》的国际新闻。其中一句："The Korean War armistice was signed in 1953, ________ a ceasefire between the two sides." 应填入什么？', choices:[{text:'bringing about — 现在分词作结果状语，表示自然而然的结果',correct:true,knowledge:'英语·非谓语动词（上海高考·语法填空）：现在分词作结果状语表示必然或自然的结果，不定式表示意外的结果。'},{text:'brought about',correct:false},{text:'to bring about',correct:false},{text:'having brought about',correct:false}] },
    ...
    // --- 新增多选 ---
    { subject:'语文', multi:true, text:'【多选】1950年代你写一篇关于新中国成立的新闻综述。以下关于新闻写作要素的说法正确的有？', choices:[{text:'新闻六要素"5W1H"——何人(Who)、何时(When)、何地(Where)、何事(What)、何因(Why)及如何(How)',correct:true,knowledge:'语文·新闻写作：5W1H是新闻写作的基本框架，确保信息完整准确。'},{text:'消息采用"倒金字塔"结构，将最重要的信息放在导语中',correct:true,knowledge:'语文·新闻写作：倒金字塔结构是消息最常用的结构，导语浓缩了新闻的核心信息。'},{text:'新闻通讯稿可以完全虚构人物和情节来增强可读性',correct:false},{text:'新闻报道的标题越长越好，需要包含全部细节',correct:false}] }
  ],
  modern: [
    ...
    { subject:'英语', text:'你的英文报道中有一句："The pandemic has ________ the way we work." 表示"深刻改变了"使用哪个词最恰当？', choices:[{text:'transformed（彻底改变）',correct:true,knowledge:'英语·近义词辨析："transform"强调本质上的彻底改变。'},{text:'changed',correct:false},{text:'altered',correct:false},{text:'varied',correct:false}] },
    ...
    // --- 新增语文题 ---
    { subject:'语文', text:'你的深度报道需要引用《论语》名句增强说服力。以下关于《论语》和孔子的说法正确的是？', choices:[{text:'《论语》是记录孔子及其弟子言行的语录体散文集，由孔子弟子及再传弟子编纂',correct:true,knowledge:'语文·文学常识（沪教版·必修）：《论语》是儒家经典，共20篇。孔子名丘字仲尼，春秋末期鲁国人，儒家学派创始人。'},{text:'《论语》全部由孔子本人亲笔撰写',correct:false},{text:'《论语》属于编年体史书',correct:false},{text:'《论语》共50篇',correct:false}] },
    { subject:'语文', text:'编辑发现一段文字有语病："通过这次采访活动，使我对基层工作有了更深的了解。"以下修改正确的是？', choices:[{text:'删除"通过"或"使"——主语残缺，介词滥用导致句子缺少主语',correct:true,knowledge:'语文·病句修改（沪教版·语言运用）：滥用介词（通过/随着/由于..."使..."）是高考常见病句类型，导致主语残缺。'},{text:'把"了解"改为"理解"',correct:false},{text:'在句首加"我"',correct:false},{text:'删除"更深的"',correct:false}] },
    { subject:'语文', text:'你报道传统文化传承，引用了古诗词。以下哪句诗的作者与朝代匹配正确？', choices:[{text:'"人生自古谁无死，留取丹心照汗青"——文天祥，南宋',correct:true,knowledge:'语文·古诗文（沪教版）：文天祥《过零丁洋》，南宋末年民族英雄，兵败被俘后英勇就义。'},{text:'"长风破浪会有时，直挂云帆济沧海"——苏轼，北宋',correct:false},{text:'"落霞与孤鹜齐飞，秋水共长天一色"——杜甫，唐',correct:false},{text:'"但愿人长久，千里共婵娟"——辛弃疾，南宋',correct:false}] },
    ...
    // --- 新增英语题 ---
    { subject:'英语', text:'英文报道中的一句话："Had it not been for the timely intervention, the situation ________ much worse." 此处应填什么？', choices:[{text:'would have been — 虚拟语气：与过去事实相反的假设，主句用would have done',correct:true,knowledge:'英语·虚拟语气（上海高考·重点语法）：Had it not been for... = If it had not been for...（省略if的倒装虚拟条件句）。'},{text:'will be',correct:false},{text:'had been',correct:false},{text:'is',correct:false}] },
    { subject:'英语', text:'一篇经济报道标题："China\'s GDP ________ by 6.5% in the first quarter." 最合适的动词是？', choices:[{text:'grew — 不及物动词"增长"，符合英语表达习惯',correct:true,knowledge:'英语·词汇辨析（上海高考）：grow为不及物动词，increase可作及物/不及物。by+百分比表示变化幅度。'},{text:'increased by 6.5% was',correct:false},{text:'was growing in',correct:false},{text:'had been increased for',correct:false}] },
    // --- 新增多选 ---
    { subject:'英语', multi:true, text:'【多选】你在撰写英文深度报道时，需要准确使用各种时态。以下关于英语时态用法的描述正确的有？', choices:[{text:'现在完成时(have/has done)强调过去动作对现在的影响——"The policy has transformed rural education."',correct:true,knowledge:'英语·时态（上海高考）：现在完成时表示过去发生的动作对现在仍有影响或结果。'},{text:'过去进行时(was/were doing)表示过去某个时间点正在发生的动作——"The reporter was interviewing farmers when the rain started."',correct:true,knowledge:'英语·时态（上海高考）：过去进行时为背景事件提供时间框架，常与一般过去时搭配使用。'},{text:'将来完成时(will have done)表示到将来某时已经完成的动作——常用于经济预测报道',correct:false},{text:'过去完成时(had done)只能用于"过去的过去"，不能独立使用',correct:false}] }
  ],
  cyberpunk: [
    { subject:'语文', text:'在脑机接口普及的时代，新闻可以直接通过神经信号传递。此时"新闻写作"最可能变成什么形式？', choices:[{text:'记者仍需要文字素养——但写作变成"神经编码"',correct:true,knowledge:'语文·未来写作：逻辑思维、语言组织、事实核查等核心写作素养在技术变革中仍然不可替代。'},{text:'不再需要文字，人类已经不需要语言交流了',correct:false},{text:'AI完全代替记者',correct:false},{text:'所有人都能直接读取他人思想',correct:false}] },
    { subject:'语文', text:'在"后真相"时代，AI生成的虚假新闻传播速度是真实新闻的10倍。作为记者，核验信息最根本的原则应该是？', choices:[{text:'追溯信源——找到信息原始出处，用多个独立信源交叉验证',correct:true,knowledge:'语文·新闻核实：在AI伪造信息泛滥的时代，信源追溯和交叉验证比以往任何时候都重要。'},{text:'相信官方发布',correct:false},{text:'转发量高的新闻就是真实的',correct:false},{text:'第一印象觉得可信就是真的',correct:false}] },
    ...
    // --- 新增语文题 ---
    { subject:'语文', text:'在信息碎片化时代，"深度阅读"能力变得珍贵。以下关于阅读方法的说法，最符合《如何阅读一本书》的是？', choices:[{text:'分析阅读——透视一本书的骨架，理解作者的论证逻辑和主旨',correct:true,knowledge:'语文·阅读方法（沪教版）：基础阅读→检视阅读→分析阅读→主题阅读四个层次。上海高考现代文阅读侧重分析性阅读。'},{text:'快速浏览每个段落的最后一句即可',correct:false},{text:'只看标题和图片就够了',correct:false},{text:'只看别人写的书评就能理解原作',correct:false}] },
    { subject:'语文', text:'审查AI生成的稿件时发现一句："这个项目取得了空前的成绩，以前从来没有过，以后也不会再有。"这句话的问题在于？', choices:[{text:'绝对化表述——"空前"+"以前从来没有"+"以后也不会再有"三重绝对化，违背客观性',correct:true,knowledge:'语文·表达准确（沪教版）：上海高考写作要求观点明确但不过于绝对，避免武断表达，常用"一定程度上""在某种条件下"等限定语。'},{text:'引用了不恰当的典故',correct:false},{text:'使用了过多的修辞手法',correct:false},{text:'句子太短不完整',correct:false}] },
    { subject:'语文', text:'你采访获得"诺贝尔文学奖"的AI作家。颁奖词说其作品"以诗意的语言展现了人类与技术的共生关系"。如果我们把AI比作"造物"，人类比作"诗人"，下面最能体现"诗人和造物的共生"这一主题的古典诗句是？', choices:[{text:'"文章本天成，妙手偶得之"——陆游，强调灵感与能力的统一',correct:true,knowledge:'语文·文化思辨（沪教版）：上海高考作文注重思辨性，常设情境让考生在传统文化与现代科技之间建立联系。'},{text:'"纸上得来终觉浅，绝知此事要躬行"',correct:false},{text:'"问渠那得清如许，为有源头活水来"',correct:false},{text:'"不畏浮云遮望眼，自缘身在最高层"',correct:false}] },
    ...
    // --- 新增英语题 ---
    { subject:'英语', text:'在未来的传媒时代，一篇学术AI生成的文章中："The algorithm, ________ by vast datasets, can now generate human-like narratives." 填入什么？', choices:[{text:'fueled — 过去分词作后置定语，表示"由...驱动/提供燃料"',correct:true,knowledge:'英语·非谓语动词（上海高考）：过去分词作定语表被动/完成。fueled by = powered by。'},{text:'fueling',correct:false},{text:'to fuel',correct:false},{text:'having fueled',correct:false}] },
    { subject:'英语', text:'全球AI伦理会议上，一位专家说："We are standing at a crossroads ________ the path we choose will determine the future of humanity." 应填什么连词？', choices:[{text:'where — 关系副词引导定语从句，修饰抽象地点名词crossroads',correct:true,knowledge:'英语·定语从句（上海高考）：当先行词为point、stage、case、situation、crossroads等表"抽象地点"的名词时，用where引导定语从句。'},{text:'which',correct:false},{text:'that',correct:false},{text:'when',correct:false}] },
    // --- 新增多选 ---
...
QUESTIONS.doctor = {
  history: [
    { subject:'生物', text:'1950年代你作为赤脚医生，发现村里很多孩子得了夜盲症。这最可能是缺乏哪种维生素？', choices:[{text:'维生素A——缺乏会导致夜盲症、干眼症',correct:true,knowledge:'生物·营养：维生素A是合成视紫红质的必需原料，缺乏时暗适应能力下降导致夜盲。'},{text:'维生素C',correct:false},{text:'维生素D',correct:false},{text:'维生素B12',correct:false}] },
    ...
    { subject:'地理', text:'你在南方农村巡回医疗，发现疟疾在夏季多发。疟疾的传播与哪个地理因素直接相关？', choices:[{text:'气候——温暖湿润适合蚊子（疟原虫宿主）繁殖',correct:true,knowledge:'地理·疾病地理：疟疾通过按蚊叮咬传播，在温暖潮湿、有积水环境中大量繁殖。'},{text:'地形——高原地区发病率最高',correct:false},{text:'纬度——高纬度地区发病率最高',correct:false},{text:'洋流——寒流经过的海岸发病率最高',correct:false}] },
    { subject:'生物', type:'fill', text:'青霉素是从______（填微生物名称）中提取的抗生素。', answer:'青霉菌', answers:['青霉素','青霉菌','Penicillium'], knowledge:'生物·微生物：青霉素由英国微生物学家弗莱明于1928年从青霉菌中发现，是人类历史上第一个抗生素。' },
    { subject:'地理', type:'fill', text:'地方性甲状腺肿的病因是人体缺乏微量元素______。', answer:'碘', answers:['碘','I'], knowledge:'地理·环境健康：碘主要来源于海洋，内陆山区土壤和水源缺碘导致甲状腺肿。' },
    // --- 新增生物题 ---
    { subject:'生物', text:'你为村民接种牛痘疫苗预防天花。关于疫苗和免疫，以下说法正确的是？', choices:[{text:'接种疫苗属于人工主动免疫——注射抗原刺激机体自身产生抗体和记忆细胞',correct:true,knowledge:'生物·免疫调节（沪教版·等级考）：人工主动免疫注射抗原（疫苗），人工被动免疫注射抗体（如抗毒素血清）。记忆细胞是二次免疫更快更强的机制。'},{text:'接种疫苗属于人工被动免疫',correct:false},{text:'牛痘疫苗直接杀死天花病毒',correct:false},{text:'疫苗中的抗原进入人体后不会引起任何免疫反应',correct:false}] },
    { subject:'生物', text:'你用显微镜观察疟疾患者的血涂片，发现红细胞内有环状体。疟原虫属于哪类生物？', choices:[{text:'原生动物（单细胞真核生物）——疟原虫属于孢子虫纲，通过按蚊传播，在红细胞内营寄生生活',correct:true,knowledge:'生物·微生物分类（沪教版）：疟原虫是真核单细胞生物（原生动物门孢子虫纲），不是细菌或病毒。有完整的细胞结构但无叶绿体。'},{text:'细菌',correct:false},{text:'病毒',correct:false},{text:'真菌',correct:false}] },
    { subject:'生物', text:'农村推广"双蒸法"去除棉籽中的棉酚毒素（Gossypol），使棉籽成为优质蛋白质来源。此处理基于棉酚的什么性质？', choices:[{text:'棉酚可溶于有机溶剂（高温蒸煮破坏细胞壁释放），利用相似相溶原理萃取',correct:true,knowledge:'生物·物质分离（沪教版）：棉酚是脂溶性多酚类物质。细胞膜破坏后，利用有机溶剂萃取法分离。'},{text:'棉酚遇热分解为无毒物质',correct:false},{text:'棉酚是水溶性的，水煮即可去除',correct:false},{text:'棉酚与蛋白质结合而失去毒性',correct:false}] },
    ...
    // --- 新增地理题 ---
    { subject:'地理', text:'1950年代你在西北某地巡回医疗，发现当地昼夜温差极大（日较差可达20°C以上）。从地理角度分析原因？', choices:[{text:'深居内陆远离海洋——大陆性气候，空气干燥少云，白天太阳辐射强升温快，夜间地面辐射冷却快降温迅速',correct:true,knowledge:'地理·气候（沪教版·等级考）：大陆性气候特征——日较差和年较差大。干燥空气和少云是昼夜温差大的关键。'},{text:'海拔极高导致',correct:false},{text:'纬度较高冬季漫长',correct:false},{text:'受寒流影响',correct:false}] },
    { subject:'地理', text:'长江中下游地区夏季高温闷热（"火炉"），但冬季阴冷潮湿。这种气候类型的名称和成因是？', choices:[{text:'亚热带季风气候——冬季受西北季风控制（低温少雨），夏季受东南季风和副热带高压交替影响（高温多雨）',correct:true,knowledge:'地理·中国气候（沪教版）：中国东部秦岭-淮河以南为亚热带季风气候，以北为温带季风气候。上海属于亚热带季风气候。'},{text:'温带海洋性气候',correct:false},{text:'地中海气候',correct:false},{text:'热带季风气候',correct:false}] },
    // --- 新增多选 ---
    { subject:'生物', multi:true, text:'【多选】你为村民接种疫苗后，需要解释免疫反应的原理。以下关于人体免疫系统的说法正确的有？', choices:[{text:'人体免疫系统分为非特异性免疫（第一、二道防线）和特异性免疫（第三道防线）',correct:true,knowledge:'生物·免疫调节（沪教版）：非特异性免疫包括皮肤黏膜屏障、吞噬细胞和杀菌物质；特异性免疫包括体液免疫和细胞免疫。'},{text:'接种疫苗属于人工主动免疫，可刺激机体产生记忆细胞，从而获得长期免疫力',correct:true,knowledge:'生物·免疫（沪教版·等级考）：记忆细胞可在二次免疫时迅速增殖分化为效应细胞，产生更快更强的免疫应答。'},{text:'抗生素可以直接增强人体免疫系统的功能',correct:false},{text:'所有疫苗都是减毒的活病毒',correct:false}] }
  ],
  modern: [
    ...
    { subject:'地理', text:'你参与全球健康研究，发现心血管疾病在发达国家发病率高。这体现了地理学中的哪个概念？', choices:[{text:'流行病学转型——经济发展使疾病谱从传染病转向慢性病',correct:true,knowledge:'地理·健康地理：流行病学转型理论描述了随经济发展，主要疾病从传染病转向慢性病的过程。'},{text:'纬度地带性',correct:false},{text:'垂直地带性',correct:false},{text:'经度地带性',correct:false}] },
    ...
    // --- 新增生物题 ---
    { subject:'生物', text:'某遗传性贫血（地中海贫血）为常染色体隐性遗传病。一对表型正常的夫妇生了一个患病孩子，再生一个孩子患病的概率是？', choices:[{text:'1/4——父母均为杂合子(Aa×Aa)，子代患病(aa)概率25%',correct:true,knowledge:'生物·遗传规律（沪教版·等级考）：常染色体隐性遗传——父母均为携带者时，子代患病概率1/4，携带者概率1/2，正常纯合概率1/4。'},{text:'1/2',correct:false},{text:'3/4',correct:false},{text:'0',correct:false}] },
    { subject:'生物', text:'某抗癌靶向药物是一种单克隆抗体，能够特异性结合癌细胞表面抗原。制备单克隆抗体的关键技术是？', choices:[{text:'将免疫的B细胞与骨髓瘤细胞融合——获得既能产生特异性抗体又能无限增殖的杂交瘤细胞',correct:true,knowledge:'生物·细胞工程（沪教版·等级考）：单克隆抗体制备流程——免疫小鼠→取B细胞→与骨髓瘤细胞融合→HAT培养基筛选→获得杂交瘤细胞→大规模培养。'},{text:'直接从患者血清中分离抗体',correct:false},{text:'用化学方法人工合成抗体分子',correct:false},{text:'从转基因植物中提取抗体',correct:false}] },
    { subject:'生物', text:'你对一个基因进行测序，发现模板链序列为 3\'-TACGGCAT-5\'。则转录出的mRNA序列为？（注意方向）', choices:[{text:'5\'-AUGCCGUA-3\'——mRNA与模板链互补且方向相反，A-T配对（U替换T），G-C配对',correct:true,knowledge:'生物·基因表达（沪教版·等级考）：转录以DNA模板链(3\'→5\')合成mRNA(5\'→3\')，遵循碱基互补配对。'},{text:'5\'-ATGCCGTA-3\'',correct:false},{text:'3\'-AUGCCGUA-5\'',correct:false},{text:'5\'-UACGGCAU-3\'',correct:false}] },
    ...
    // --- 新增地理题 ---
    { subject:'地理', text:'你分析某城市医疗资源分布图，发现优质医院高度集中在市中心。这体现了城市内部空间结构的什么规律？', choices:[{text:'中心地理论——高等级服务（三甲医院）服务范围大、门槛高，倾向于布局在人口密度最高的城市中心',correct:true,knowledge:'地理·城市地理（沪教版）：中心地理论（克里斯泰勒）解释服务等级与空间分布关系。医院等级越高，服务门槛越高，服务范围越大。'},{text:'同心圆模型',correct:false},{text:'扇形模型',correct:false},{text:'多核心模型',correct:false}] },
  ...
  cyberpunk: [
    ...
    { subject:'地理', text:'在海平面上升淹没大部分沿海城市的时代，你参与评估"海上城市"的选址。以下哪个地理条件最适合？', choices:[{text:'大陆架坡度平缓、水深<50m、远离板块交界处和台风路径',correct:true,knowledge:'地理·海洋地理：海上城市选址需考虑水深、海底稳定性、自然灾害风险、洋流等因素。'},{text:'深海区（>1000m）远离陆地',correct:false},{text:'两极地区冰层之上',correct:false},{text:'板块交界处地热资源丰富',correct:false}] },
    ...
    // --- 新增生物题 ---
    { subject:'生物', text:'基因治疗中，如何将正常的CFTR基因导入囊性纤维化患者的肺上皮细胞？最常用的载体是？', choices:[{text:'腺相关病毒（AAV）载体——安全性高、免疫原性低、可感染非分裂细胞',correct:true,knowledge:'生物·基因治疗（沪教版·基因工程应用）：载体选择原则——安全性（低免疫原性）、高效转导、靶向性。AAV和慢病毒是最常用的病毒载体。'},{text:'质粒直接注射',correct:false},{text:'脂质体包裹后口服',correct:false},{text:'直接用显微注射针打入每个细胞',correct:false}] },
    { subject:'生物', text:'【多选】人工合成基因线路（Synthetic gene circuits）可用于设计"智能细胞"实现精准药物释放。以下哪些是合成生物学的基本元件？', multi:true, choices:[{text:'启动子——控制基因转录的起始',correct:true,knowledge:'生物·合成生物学（沪教版拓展）：合成生物学将工程学原理应用于生物学，用标准化元件（启动子、RBS、CDS、终止子等）构建基因线路。'},{text:'核糖体结合位点（RBS）——调控翻译效率',correct:true},{text:'终止子——控制转录的终止',correct:true},{text:'细胞膜——保护细胞不被外界损害',correct:false}] },
    { subject:'生物', text:'火星基地使用藻类生物反应器产生O₂并回收CO₂。在微观层面，这一过程依赖于什么细胞器？', choices:[{text:'叶绿体——光合作用的光反应（类囊体薄膜）产生O₂，暗反应（基质）固定CO₂生成有机物',correct:true,knowledge:'生物·光合作用（沪教版·等级考）：光反应：H₂O光解→O₂+[H]+ATP；暗反应（卡尔文循环）：CO₂+C₅→2C₃→C₆H₁₂O₆+C₅。'},{text:'线粒体',correct:false},{text:'核糖体',correct:false},{text:'内质网',correct:false}] },
    ...
    // --- 新增地理题 ---
    { subject:'地理', text:'根据世界卫生组织预测，2050年全球70%人口将居住在城市。快速城市化对传染病传播的影响是？', choices:[{text:'人口密度增大和流动性增强加速病原体传播，但也提高了医疗资源可及性——这是一把双刃剑',correct:true,knowledge:'地理·城市化（沪教版·等级考）：城市化带来的机遇（经济集聚、公共服务）和挑战（环境污染、疾病传播加速）需要辩证分析。'},{text:'城市化完全消除了传染病',correct:false},{text:'城市化对传染病无任何影响',correct:false},{text:'城市化只影响非传染性慢性病',correct:false}] },
    { subject:'地理', text:'随着全球变暖，原本局限于热带地区的登革热正在向温带扩散。中国哪些地区面临登革热传播范围扩大的风险？', choices:[{text:'华东和华南沿海地区——气温升高延长了蚊虫活动季节，城市化产生更多积水容器（蚊虫孳生地）',correct:true,knowledge:'地理·气候变化与健康（沪教版）：全球变暖使等温线北移，热带传染病媒介（按蚊、伊蚊）的分布范围随之向高纬度和高海拔扩展。'},{text:'只有海南岛和西双版纳',correct:false},{text:'西北内陆干旱区',correct:false},{text:'东北地区因纬度高完全安全',correct:false}] },
    // --- 新增多选 ---
    { subject:'生物', multi:true, text:'【多选】纳米医学时代，你开发的靶向给药系统需要满足哪些条件才能精准递送抗癌药物？', choices:[{text:'纳米载体需具备靶向识别功能——表面修饰特异性配体，识别癌细胞表面的标志物',correct:true,knowledge:'生物·细胞工程：靶向给药利用"锁钥"原理，配体-受体特异性结合实现精准递送。'},{text:'载体需在特定微环境（如肿瘤酸性微环境pH≈6.5）下可控释放药物',correct:true,knowledge:'生物·医学工程：pH响应型纳米载体可在肿瘤酸性环境中释放药物，减少对正常组织的损伤。'},{text:'只要药物剂量足够大，不需要靶向递送也能有效治疗',correct:false},{text:'纳米载体越复杂越好，不需要考虑生物兼容性问题',correct:false}] }
  ]
};
...
QUESTIONS.programmer = {
  history: [
    { subject:'信息科技', text:'1958年你接触到中国第一台通用电子计算机——103机。这台计算机使用的核心元件是什么？', choices:[{text:'电子管——第一代计算机使用电子管作为开关元件',correct:true,knowledge:'信息科技·计算机史：103机用了近3000个电子管，每秒运算1800次。电子管体积大、发热高。'},{text:'晶体管',correct:false},{text:'集成电路',correct:false},{text:'微处理器',correct:false}] },
    { subject:'信息科技', text:'你使用穿孔纸带向计算机输入程序。纸带上有孔代表1、无孔代表0，这属于哪种数据表示方式？', choices:[{text:'二进制编码——用有无孔两种状态表示二进制数',correct:true,knowledge:'信息科技·数据表示：莱布尼茨最早提出二进制，布尔代数将逻辑运算与二进制联系。'},{text:'模拟信号',correct:false},{text:'量子比特',correct:false},{text:'十进制编码',correct:false}] },
    ...
    // --- 新增信息科技题 ---
    { subject:'信息科技', text:'你用汇编语言编写103机的程序。汇编语言与机器语言的主要区别是什么？', choices:[{text:'汇编语言使用助记符（如MOV、ADD）替代二进制机器码，每条汇编指令对应一条机器指令',correct:true,knowledge:'信息科技·程序设计语言：机器语言(0/1)→汇编语言(助记符)→高级语言。汇编器将助记符翻译为机器码。'},{text:'汇编语言可以直接在操作系统上运行不需要翻译',correct:false},{text:'汇编语言是面向对象的高级语言',correct:false},{text:'汇编语言与硬件架构无关可在所有计算机上通用',correct:false}] },
    { subject:'信息科技', text:'早期程序员使用流程图描述算法逻辑。以下关于算法和流程图的说法正确的是？', choices:[{text:'算法必须具有有穷性——在有限步骤内结束，不能无限循环',correct:true,knowledge:'信息科技·算法基础（上海教材）：算法的5个特征——有穷性、确定性、可行性、输入（0或多个）、输出（1或多个）。'},{text:'一个算法可以有多个不同的输出对于同一个输入',correct:false},{text:'流程图中的菱形表示程序的开始/结束',correct:false},{text:'任何算法都必须包含循环结构',correct:false}] },
    ...
    { subject:'历史', text:'中国在1964年成功爆炸第一颗原子弹。在两弹一星工程中，归国科学家发挥了关键作用，其中不包括？', choices:[{text:'杨振宁——主要从事理论物理研究，获得诺贝尔物理学奖，但未直接参与两弹一星工程',correct:true,knowledge:'历史·两弹一星（沪教版）：钱学森（航天）、邓稼先（核物理）、钱三强（核物理）等是两弹一星的核心科学家。杨振宁主要贡献在理论物理领域。'},{text:'钱学森',correct:false},{text:'邓稼先',correct:false},{text:'钱三强',correct:false}] },
    // --- 新增多选 ---
    { subject:'信息科技', multi:true, text:'【多选】你为一台早期的电子管计算机编写程序。以下关于计算机工作原理的说法正确的有？', choices:[{text:'冯·诺依曼体系结构的核心思想是"存储程序"——指令和数据以二进制形式存储在内存中，CPU按序取指执行',correct:true,knowledge:'信息科技·计算机原理（上海教材）：冯·诺依曼体系结构包括运算器、控制器、存储器、输入设备和输出设备五大部件。'},{text:'计算机内部采用二进制表示数据和指令，二进制只有0和1两种状态，与电子元件的开关特性相契合',correct:true,knowledge:'信息科技·数据表示：二进制是计算机的基础，所有数据和指令最终都转化为二进制码。'},{text:'第一代计算机已经可以运行图形化用户界面',correct:false},{text:'计算机的运算速度只取决于CPU的主频，与内存大小无关',correct:false}] }
  ],
  modern: [
    { subject:'信息科技', text:'你开发了一个电商平台，用户登录后可以保持在线状态。服务器存储用户登录状态最常用的机制是？', choices:[{text:'Session/Cookie——服务器创建session，客户端用cookie保存session ID',correct:true,knowledge:'信息科技·Web开发：HTTP无状态，Session在服务端存用户数据，Cookie在客户端存标识符。'},{text:'每次登录重新输入密码',correct:false},{text:'用IP地址识别用户',correct:false},{text:'用USB硬件KEY验证',correct:false}] },
    { subject:'信息科技', text:'你的APP用户数据泄露，原因是数据库存储密码时用了明文。以下哪种密码存储方式最安全？', choices:[{text:'加盐哈希（bcrypt/scrypt）——每个密码加随机数后哈希',correct:true,knowledge:'信息科技·安全："盐"是每个用户唯一的随机字符串。加盐哈希防止了相同密码产生相同哈希值的问题。'},{text:'将密码用Base64编码',correct:false},{text:'将密码用MD5哈希一次',correct:false},{text:'将密码压缩成ZIP',correct:false}] },
    ...
    // --- 新增信息科技题 ---
    { subject:'信息科技', text:'你使用Python开发数据分析功能。以下Python代码的输出是什么？<br><code>nums = [1, 2, 3]\nresult = [x*2 for x in nums if x > 1]\nprint(result)</code>', choices:[{text:'[4, 6]——列表推导式：遍历nums中元素，只取>1的(2和3)，各乘以2，生成新列表[4,6]',correct:true,knowledge:'信息科技·Python编程（上海高中信息科技）：列表推导式 [表达式 for 变量 in 可迭代对象 if 条件] 是一种简洁的列表生成方式。'},{text:'[2, 4, 6]',correct:false},{text:'[2, 3]',correct:false},{text:'[4, 6, 6]',correct:false}] },
    { subject:'信息科技', text:'你设计一个数据库来存储用户订单信息。以下关于数据库规范化的说法正确的是？', choices:[{text:'第三范式（3NF）要求每个非主键字段直接依赖于主键而非依赖于其他非主键字段——消除传递依赖',correct:true,knowledge:'信息科技·数据库（上海教材）：1NF(原子性)→2NF(消除部分依赖)→3NF(消除传递依赖)。规范化减少数据冗余和更新异常。'},{text:'数据库规范化程度越高越好，所有表都应设计到第5范式',correct:false},{text:'第一范式要求所有字段都是相同的类型',correct:false},{text:'主键和外键在数据库中必须是同一个字段',correct:false}] },
    { subject:'信息科技', text:'你的系统需要实现"用户A关注用户B"的社交关系。从数据结构角度，这种关系最适合用什么表示？', choices:[{text:'图——用户是顶点，关注关系是有向边（A→B表示A关注B），支持快速查询粉丝数、关注数和关系链',correct:true,knowledge:'信息科技·数据结构：图(Graph)适合表示实体间多对多的网络关系。社交网络（关注/好友）、推荐系统（用户-商品）都基于图结构。'},{text:'队列（Queue）',correct:false},{text:'栈（Stack）',correct:false},{text:'散列表（Hash Table）',correct:false}] },
    ...
    // --- 新增历史题 ---
    { subject:'历史', text:'从冷战时期的ARPANET到1990年代万维网（WWW）的诞生，互联网从军用网络演变为全球开放平台。这个过程中最关键的技术发明是？', choices:[{text:'Tim Berners-Lee发明了HTTP协议、HTML语言和URL系统——实现超文本链接，使信息可以在不同计算机之间自由连接',correct:true,knowledge:'历史·互联网史（沪教版）：1990年Berners-Lee在CERN发明万维网三大核心技术（HTTP+HTML+URL）。1993年Mosaic浏览器的出现使万维网走向大众。'},{text:'TCP/IP协议的发明',correct:false},{text:'电子邮件的发明',correct:false},{text:'搜索引擎的发明',correct:false}] },
    { subject:'历史', text:'中国"新四大发明"（高铁、扫码支付、共享单车、网购）被写入一些国际报告。从历史角度，这一现象最能说明什么？', choices:[{text:'数字技术与实体经济深度融合，创造了具有中国特色的技术创新范式——不是简单模仿，而是基于庞大市场和独特需求的再创新',correct:true,knowledge:'历史·科技与文明（沪教版）：近代以来中国科技经历了从"跟跑"到"并跑"再到部分领域"领跑"的历程。移动支付和共享经济体现了应用层面的创新优势。'},{text:'中国在所有科技领域都已超越发达国家',correct:false},{text:'这四项技术都是由中国原创发明的',correct:false},{text:'中国已经完成了现代化建设所有目标',correct:false}] },
    // --- 新增多选 ---
  ...
  cyberpunk: [
    { subject:'信息科技', text:'你需要在量子计算机上实现Shor算法。与传统计算机相比，量子计算机在解决哪个问题上具有绝对优势？', choices:[{text:'大整数因式分解——Shor算法可在多项式时间内分解大整数',correct:true,knowledge:'信息科技·量子计算：Shor算法（1994年）意味着RSA加密体系将被量子计算机攻破。'},{text:'网页搜索排序',correct:false},{text:'文字处理排版',correct:false},{text:'数据库增删改查',correct:false}] },
    { subject:'信息科技', text:'强人工智能（AGI）已诞生，你负责设计AI伦理框架。以下哪项应是AI系统的核心安全原则？', choices:[{text:'价值对齐——AI的目标和行为必须与人类价值观保持一致',correct:true,knowledge:'信息科技·AI伦理：价值对齐（Value Alignment）是AI安全的核心问题。'},{text:'AI应该有完全的自主权',correct:false},{text:'AI的目标不需要限制',correct:false},{text:'AI应该取代人类做所有决策',correct:false}] },
    ...
    { subject:'历史', text:'在数字意识普及的2080年代，数字永生者的记录和碳基人类的记录互相矛盾。解决这个问题最根本的原则是？', choices:[{text:'多信源交叉验证——历史真实性由独立信源的相互印证程度决定',correct:true,knowledge:'历史·史学方法：不论记录者是人是AI，"孤证不立"、互证、考据等基本方法永远是确定历史事实的根本途径。'},{text:'以AI记录为准',correct:false},{text:'以人类记录为准',correct:false},{text:'所有记录都是假的',correct:false}] },
    // --- 新增信息科技题 ---
    { subject:'信息科技', text:'量子计算机利用量子叠加态（0和1可以同时存在）实现并行计算。n个量子比特可以同时表示多少种状态？', choices:[{text:'2^n种——每个量子比特可处于|0⟩和|1⟩的叠加态，n个量子比特可同时编码2^n个基态的叠加',correct:true,knowledge:'信息科技·量子计算原理：经典比特只能是0或1。量子比特(qubit)可以处于|0⟩、|1⟩或两者的叠加态α|0⟩+β|1⟩。n个qubit→2^n维Hilbert空间。'},{text:'2n种',correct:false},{text:'n²种',correct:false},{text:'n!种',correct:false}] },
    { subject:'信息科技', text:'为防止量子计算机破解RSA加密，你在设计后量子密码（PQC）系统。相比RSA，以下哪种数学问题是量子计算机也难以高效解决的？', choices:[{text:'格（Lattice）上的最短向量问题（SVP）——目前没有已知量子算法能高效解决',correct:true,knowledge:'信息科技·密码学：NIST已标准化基于格的密码方案（CRYSTALS-Kyber等）作为后量子密码标准。格的困难性问题目前同时抵抗经典和量子攻击。'},{text:'大整数因式分解',correct:false},{text:'离散对数问题',correct:false},{text:'椭圆曲线离散对数问题',correct:false}] },
    { subject:'信息科技', text:'【多选】AI伦理中的"可解释性"（Explainability）问题是指？', multi:true, choices:[{text:'深度学习模型的决策过程类似"黑箱"，难以用人类理解的语言说明为什么做出某个决策',correct:true,knowledge:'信息科技·AI伦理：可解释AI（XAI）是当前AI研究的核心挑战之一。黑箱问题导致无法审计AI决策的公平性。'},{text:'金融风控AI拒绝贷款申请时必须能给出明确理由',correct:true},{text:'医疗AI诊断结果需要能够追溯推理依据',correct:true},{text:'AI程序必须在运行时输出所有内部变量',correct:false}] },
    ...
    // --- 新增历史题 ---
    { subject:'历史', text:'人类社会经历了"采集狩猎→农业→工业→信息"四次重大转型。从历史唯物主义的角度，驱动这些转型的根本动力是什么？', choices:[{text:'生产力的发展——生产工具的革新和能源利用方式的变革驱动了生产关系的调整和社会形态的更替',correct:true,knowledge:'历史·唯物史观（沪教版）：生产力决定生产关系，经济基础决定上层建筑。每一次社会大转型背后都是能源、工具、组织方式的革命性变革。'},{text:'天才人物的偶然出现',correct:false},{text:'外来文明的侵入和征服',correct:false},{text:'人口的机械增长',correct:false}] },
    { subject:'历史', text:'随着AGI在法律、医疗等领域的应用，人类的就业结构正在发生深刻变化。历史上类似的技术冲击有？', choices:[{text:'18世纪工业革命时期，卢德分子捣毁机器的运动——技术替代人工引发的社会冲突在历史上反复出现，但每次最终都创造了更多新岗位',correct:true,knowledge:'历史·技术与社会（沪教版）：工业革命时期纺织工人捣毁机器的"卢德运动"是最早的反自动化运动。历史证明技术革新在淘汰旧岗位的同时创造了更多新就业机会。'},{text:'古罗马引入奴隶制导致自由民全部失业',correct:false},{text:'中世纪黑死病导致欧洲经济全面崩溃',correct:false},{text:'大航海时代使所有传统手工业消失',correct:false}] }
  ]
};
...
QUESTIONS.engineer = {
  history: [
    { subject:'数学', text:'1950年代你参与修建一座水库大坝。图纸上大坝截面是梯形，上底4m、下底16m、高10m。截面积是多少？', choices:[{text:'100m²——梯形面积=(上底+下底)×高÷2=(4+16)×10÷2=100',correct:true,knowledge:'数学·几何：梯形面积公式S=(a+b)h/2，是最基本的工程计算之一。'},{text:'200m²',correct:false},{text:'80m²',correct:false},{text:'160m²',correct:false}] },
    { subject:'数学', text:'炼钢厂将铁水（1500°C）倒入模具冷却。若冷却速率与温差成正比（牛顿冷却定律），以下哪个图像最能描述温度变化？', choices:[{text:'先快速下降，后缓慢下降，逐渐趋近室温——指数衰减曲线',correct:true,knowledge:'数学·函数模型：牛顿冷却定律dT/dt=-k(T-T₀)，温度呈指数衰减，初始温差大冷却快。'},{text:'匀速下降——直线',correct:false},{text:'先慢后快——越来越陡',correct:false},{text:'保持不变后突然下降——阶梯状',correct:false}] },
    { subject:'物理', text:'你建设水利工程需要将水从低处抽到高处灌溉。以下哪种简单机械最适合提升水？', choices:[{text:'螺旋泵（阿基米德螺旋）——利用螺旋斜面将水提升',correct:true,knowledge:'物理·简单机械：阿基米德螺旋是最早的提水机械之一，利用螺旋面旋转将水沿管壁提升。'},{text:'滑轮组',correct:false},{text:'杠杆',correct:false},{text:'齿轮组',correct:false}] },
    { subject:'物理', text:'土高炉炼铁时用鼓风机鼓入空气。旋转叶片推动空气使其获得速度和压力，这主要利用了哪个物理定律？', choices:[{text:'能量守恒定律——机械能转化为空气的动能和压力能',correct:true,knowledge:'物理·能量转化：鼓风机本质上将电能/机械能转化为流体的动能和压力能。'},{text:'伯努利原理',correct:false},{text:'牛顿第三定律',correct:false},{text:'热力学第二定律',correct:false}] },
    ...
    // --- 新增数学题 ---
    { subject:'数学', text:'施工队需要在两座山之间架设电线。两座山峰坐标分别为A(0,0)和B(800,120)（单位：米），假设电线理想形状为抛物线y=ax²+bx。已知电线在x=400处最低，求a的值。', choices:[{text:'a=120/160000=0.00075——抛物线顶点在x=400=-b/(2a)，代入B点求a',correct:true,knowledge:'数学·二次函数（上海高考）：抛物线y=ax²+bx+c，对称轴x=-b/(2a)。本问题属于典型的二次函数建模应用。'},{text:'a=0.0012',correct:false},{text:'a=0.0005',correct:false},{text:'a=0.001',correct:false}] },
    { subject:'数学', text:'水库设计中需要计算混凝土方量。大坝横截面近似为抛物线y=0.01x²（0≤x≤20），旋转180°得到的体积由积分∫π[f(x)]²dx给出。这种计算方法属于？', choices:[{text:'定积分的应用——用旋转体体积公式V=π∫[f(x)]²dx计算',correct:true,knowledge:'数学·定积分应用（上海高考）：旋转体体积公式是积分几何应用的重要内容，与祖暅原理有密切联系。'},{text:'微积分基本定理的直接使用',correct:false},{text:'二项式定理的拓展应用',correct:false},{text:'解析几何中的面积公式',correct:false}] },
    { subject:'数学', text:'为节省钢材，你需要在给定了周长条件下使矩形截面积最大。设周长为20m，长宽各为多少时面积最大？', choices:[{text:'5m×5m，面积25m²——定周长矩形中正方形面积最大，由基本不等式a+b≥2√(ab)得ab≤(周长/4)²',correct:true,knowledge:'数学·不等式（上海高考）：均值不等式——定和求积最大值，积为定值求和最小值。两次基本不等式的标准用法。'},{text:'6m×4m，面积24m²',correct:false},{text:'7m×3m，面积21m²',correct:false},{text:'8m×2m，面积16m²',correct:false}] },
    ...
    // --- 新增物理题 ---
    { subject:'物理', text:'大坝底部为什么要设计得比顶部宽？从液体压强的角度分析。', choices:[{text:'液体压强p=ρgh——深度越大压强越大，底部承受更大的水压力，需要更宽的结构分散应力',correct:true,knowledge:'物理·液体压强（沪教版·等级考）：静止液体压强p=ρgh（h为深度），与容器形状无关。坝体底部h最大所以p最大。'},{text:'为了美观',correct:false},{text:'为了节省建筑材料',correct:false},{text:'因为底部水温更低',correct:false}] },
    { subject:'物理', text:'你使用滑轮组将500kg的石料提升到10m高的坝顶。不计摩擦和滑轮重，理论上最少需要做多少功？（g=10m/s²）', choices:[{text:'50000J——W=mgh=500×10×10=50000J，机械效率为1的理想情况下最少做功',correct:true,knowledge:'物理·功和能（沪教版·等级考）：功W=F·s·cosθ。重力做功W=mgh与路径无关。机械效率η=W有/W总。'},{text:'5000J',correct:false},{text:'500000J',correct:false},{text:'25000J',correct:false}] },
    // --- 新增多选 ---
    { subject:'物理', multi:true, text:'【多选】水利工程建设中常涉及多种简单机械的组合使用。以下关于简单机械的说法正确的有？', choices:[{text:'使用动滑轮可以省力，但费距离——F=G/2，s=2h，实质是动力臂为阻力臂2倍的杠杆',correct:true,knowledge:'物理·简单机械（沪教版·等级考）：动滑轮是等臂杠杆的变形，省力不省功。机械功原理：使用任何机械都不省功。'},{text:'斜面是一种省力机械——斜面越长、倾角越小越省力，但需要移动更远的距离',correct:true,knowledge:'物理·简单机械：斜面(F=G·h/L，L为斜面长度)广泛应用于水利工程中的物料运输。机械效率η=W有/W总。'},{text:'使用任何机械都能既省力又省距离',correct:false},{text:'滑轮组的机械效率总是100%，没有任何能量损失',correct:false}] }
  ],
  modern: [
    { subject:'数学', text:'你设计一座跨江大桥。一辆重20吨的卡车停在40m简支梁的跨中，左端支座承受的压力是？', choices:[{text:'10吨——卡车在正中，两端各分担一半',correct:true,knowledge:'数学·力学：简支梁在对称荷载下，两端支座反力相等。'},{text:'20吨',correct:false},{text:'5吨',correct:false},{text:'15吨',correct:false}] },
    { subject:'数学', text:'你用BIM做建筑能耗模拟，发现夏季空调能耗与室外温度平方成正比。温度从35°C升至40°C，能耗约增加多少？', choices:[{text:'约31%——(40²-35²)/35²≈0.306',correct:true,knowledge:'数学·比例计算：能耗∝T²，温度比率的平方=能耗比率。40/35≈1.143，平方≈1.306。'},{text:'约14%',correct:false},{text:'约50%',correct:false},{text:'约100%',correct:false}] },
    { subject:'物理', text:'你负责超高层建筑电梯系统。电梯以2m/s²加速上升时，体重70kg的人对地板压力是多少？（g=10m/s²）', choices:[{text:'840N——N=m(g+a)=70×(10+2)=840N',correct:true,knowledge:'物理·牛顿第二定律：电梯加速上升时人处于"超重"状态，N-mg=ma，所以N=m(g+a)。'},{text:'700N',correct:false},{text:'560N',correct:false},{text:'140N',correct:false}] },
    { subject:'物理', text:'你设计太阳能光伏电站。单晶硅板光电转换效率约20%，某地年太阳辐射1200kWh/m²。1m²板一年约发多少电？', choices:[{text:'240kWh——1200×20%=240kWh',correct:true,knowledge:'物理·能源转化：光电转换效率=输出电能/输入光能。实际还要考虑温度损失、逆变器效率。'},{text:'1200kWh',correct:false},{text:'24kWh',correct:false},{text:'600kWh',correct:false}] },
    ...
    // --- 新增数学题 ---
    { subject:'数学', text:'某高层建筑的外形可近似为一个旋转抛物面z=(x²+y²)/100（0≤z≤100，单位：m），底部半径是多少？', choices:[{text:'100m——当z=100时，x²+y²=10000，所以半径r=100m',correct:true,knowledge:'数学·解析几何（上海高考）：立体几何中截面问题，z=100代入方程得截面圆方程x²+y²=R²。'},{text:'10m',correct:false},{text:'200m',correct:false},{text:'50m',correct:false}] },
    { subject:'数学', text:'工程进度管理中，土方施工量按等差数列递增：第一天挖100m³，之后每天多挖20m³。第n天完成的总量是多少？', choices:[{text:'Sₙ=n[2×100+(n-1)×20]/2=10n(10+n)——等差数列前n项和公式',correct:true,knowledge:'数学·数列（上海高考）：等差前n项和Sₙ=n(a₁+aₙ)/2=n[2a₁+(n-1)d]/2。上海高考数列题常与实际应用结合。'},{text:'100+20(n-1)',correct:false},{text:'100n+20',correct:false},{text:'100×20^(n-1)',correct:false}] },
    { subject:'数学', text:'风荷载作用下，高楼的摆动位移d(t)=Asin(ωt)，最大位移为0.5m，周期为4秒。t=1s时的位移是多少？', choices:[{text:'d(1)=0.5sin(2π×1/4)=0.5sin(π/2)=0.5m——ω=2π/T=π/2，代入t=1得最大值',correct:true,knowledge:'数学·三角函数（上海高考）：正弦函数模型y=Asin(ωx+φ)，振幅A、角频率ω=2π/T。上海高考数学常考三角函数建模。'},{text:'0.25m',correct:false},{text:'0m',correct:false},{text:'0.35m',correct:false}] },
    ...
    // --- 新增物理题 ---
    { subject:'物理', text:'桥梁设计中使用钢索承担拉力。一根截面积S=10cm²的钢索承受F=2×10⁵N的拉力，产生的应力是？（注意单位换算）', choices:[{text:'σ=F/S=2×10⁵/(10×10⁻⁴)=2×10⁸Pa=200MPa',correct:true,knowledge:'物理·力学（沪教版·等级考）：应力σ=F/S，单位Pa=N/m²。10cm²=10×10⁻⁴m²。这是工程力学的核心计算。'},{text:'2×10⁶Pa',correct:false},{text:'2×10⁴Pa',correct:false},{text:'2000Pa',correct:false}] },
    { subject:'物理', text:'大楼避雷针的工作原理是利用了哪种物理现象？', choices:[{text:'尖端放电——导体尖端处电荷密度大，电场强度大于周围空气的击穿场强（约3×10⁶V/m），优先形成放电通道将雷电流导入大地',correct:true,knowledge:'物理·静电（沪教版·等级考）：导体表面电荷密度与曲率半径成反比（尖端效应），尖端电场强度最大。上海等级考常考静电防护的实际应用。'},{text:'电磁感应',correct:false},{text:'热电效应',correct:false},{text:'光电效应',correct:false}] }
  ],
  cyberpunk: [
    { subject:'数学', text:'你设计量子计算机纠错码。每个量子比特出错概率0.1%，采用"三比特重复码"后逻辑比特的出错概率是？', choices:[{text:'约0.0003%——3p²=3×(0.001)²=3×10⁻⁶',correct:true,knowledge:'数学·概率：三比特重复码可容忍1个比特出错。≥2个出错时才会出错，P≈C(3,2)p²=3p²。'},{text:'约0.1%',correct:false},{text:'约0.01%',correct:false},{text:'约1%',correct:false}] },
    { subject:'数学', text:'你设计的地下城市穹顶是半球体，半径500m。计算内表面需涂多少防护涂料，应算什么？', choices:[{text:'球表面积的一半——S=2πr²≈157万平方米',correct:true,knowledge:'数学·几何：半球体表面积（不含底面）=2πr²。穹顶内表面即半球体的内表面。'},{text:'球的整个表面积',correct:false},{text:'圆的面积πr²',correct:false},{text:'半球体积的一半',correct:false}] },
    { subject:'物理', text:'你设计反重力引擎——抵消100吨飞船的重力。需提供多少向上的力？（g=9.8m/s²）', choices:[{text:'约980,000N——F=mg=100,000×9.8=980,000N',correct:true,knowledge:'物理·力学：F=mg，抵消重力需大小相等方向相反的力。'},{text:'980N',correct:false},{text:'9,800N',correct:false},{text:'98,000,000N',correct:false}] },
    { subject:'物理', text:'城市能源来自轨道太阳能电站，通过微波传输。发射功率1GW，传输效率60%，接收端获得多少功率？', choices:[{text:'600MW——1GW×60%=0.6GW=600MW',correct:true,knowledge:'物理·能源传输：微波无线输电受波束发散、大气吸收影响。'},{text:'1GW',correct:false},{text:'60MW',correct:false},{text:'0.6W',correct:false}] },
    // --- 新增数学题 ---
    { subject:'数学', text:'在设计空间电梯（太空电梯）时，缆绳需要从地球同步轨道（约36000km高处）延伸到地面。缆绳张力T(x)随高度x的变化满足微分方程dT/dx=-ρ(x)g(x)，其中ρ(x)是密度函数、g(x)是重力加速度。若假设g=常数，ρ=常数，T(h)=0（顶端自由），则地面处张力T(0)=？', choices:[{text:'T(0)=ρgh——对dT/dx=-ρg积分得T(x)=ρg(h-x)+C，由T(h)=0得C=0，故T(0)=ρgh',correct:true,knowledge:'数学·微分方程（上海高考·定积分应用）：T(h)-T(0)=∫₀ʰ(-ρg)dx=-ρgh，所以T(0)=ρgh。等于是缆绳的总重量。'},{text:'T(0)=ρgh/2',correct:false},{text:'T(0)=0',correct:false},{text:'T(0)=ρgh²',correct:false}] },
    { subject:'数学', text:'火星城市建设中需要对资源进行优化分配。你有a元预算，用于建造水循环系统（单位成本m元，效益函数U=n₁ln(w)）和氧气生产系统（单位成本n元，效益函数V=n₂ln(q)）。在预算约束下最大化总效益，这种问题属于？', choices:[{text:'条件极值问题——用拉格朗日乘数法在约束条件mw+nq=a下最大化U+V',correct:true,knowledge:'数学·最优化（上海高考·导数应用）：带约束的最优化→构造拉格朗日函数L=U(m)+V(n)+λ(a-mw-nq)，求偏导联立求解。上海高考导数部分涉及最值应用题。'},{text:'线性规划问题',correct:false},{text:'概率统计中的假设检验',correct:false},{text:'数列的极限问题',correct:false}] },
    { subject:'数学', text:'【多选】关于向量，以下说法正确的有？', multi:true, choices:[{text:'两个非零向量a和b垂直的充要条件是a·b=0',correct:true,knowledge:'数学·向量（上海高考）：向量坐标运算、数量积、向量垂直/平行的判定条件是高考必考内容。'},{text:'|a+b|≤|a|+|b|（三角不等式），等号成立当且仅当a与b同向',correct:true},{text:'向量a在向量b方向上的投影为|a|cosθ=(a·b)/|b|',correct:true},{text:'任意两个向量都可以相加得到新的向量',correct:false}] },
    ...
    // --- 新增物理题 ---
    { subject:'物理', text:'太空电梯的缆绳在接近地球同步轨道高度时需要承受极大张力，材料必须具有极高的比强度（强度/密度）。碳纳米管的抗拉强度可达约63GPa，密度约1.3g/cm³。若缆绳长度为36000km，其在地面端的应力约为？（假设g=10m/s²，不计材料自重变化）', choices:[{text:'约468GPa——σ=ρLg=1300×3.6×10⁷×10=4.68×10¹¹Pa=468GPa，远超现有材料强度，这就是太空电梯的最大技术挑战',correct:true,knowledge:'物理·力学（沪教版·等级考）：均匀缆绳自重产生的最大应力在悬挂点处，σ=ρLg。目前尚无材料能满足太空电梯的强度要求。'},{text:'约46.8GPa',correct:false},{text:'约4.68GPa',correct:false},{text:'约4680GPa',correct:false}] },
    { subject:'物理', text:'火星基地使用核电池（放射性同位素热电发生器RTG），将Pu-238衰变产生的热能通过热电偶直接转换为电能。其中的热电偶利用了哪种物理效应？', choices:[{text:'塞贝克效应——两种不同导体两端温度不同时产生电动势（温差电效应）',correct:true,knowledge:'物理·热学/电磁学（沪教版·等级考）：塞贝克效应（1821年发现）是热电偶和RTG的核心原理，属于热能与电能的直接转换。上海等级考涉及能源转换技术。'},{text:'光电效应',correct:false},{text:'霍尔效应',correct:false},{text:'多普勒效应',correct:false}] },
    { subject:'物理', text:'为保护火星基地免受宇宙射线（主要是高能质子）伤害，需要电磁屏蔽。以下方案中最可行的原理是？', choices:[{text:'利用磁场使带电粒子偏转——洛伦兹力F=qv×B使质子做圆周运动，磁场越强偏转半径越小',correct:true,knowledge:'物理·电磁学（沪教版·等级考）：洛伦兹力始终垂直于速度方向，不做功，使带电粒子在磁场中做匀速圆周运动。这是主动屏蔽高能粒子的原理方案。'},{text:'用厚重的铅板物理阻挡',correct:false},{text:'用激光直接射毁宇宙射线粒子',correct:false},{text:'用声波干扰粒子运动轨迹',correct:false}] },
...
function initAllGrades() {
    ...
    // --- 农民·高二补充 ---
    QUESTIONS.farmer.history.push(
        { grade:'高二', subject:'化学', text:'配制一定物质的量浓度的NaOH溶液时，以下操作会导致浓度偏高的是？', choices:[{text:'定容时俯视刻度线——溶液体积偏小，浓度偏高',correct:true,knowledge:'化学·一定物质的量浓度配制（高二·选择性必修）：俯视→V偏小→c偏高；仰视→V偏大→c偏低。'},{text:'定容时仰视刻度线',correct:false},{text:'未洗涤烧杯和玻璃棒',correct:false},{text:'称量时砝码放在左盘',correct:false}] }
    );
    QUESTIONS.farmer.modern.push(
        { grade:'高二', subject:'化学', text:'Na₂CO₃溶液中，各离子浓度大小关系正确的是？', choices:[{text:'c(Na⁺)>c(CO₃²⁻)>c(OH⁻)>c(HCO₃⁻)>c(H⁺)——Na₂CO₃完全电离，CO₃²⁻部分水解',correct:true,knowledge:'化学·离子浓度比较（高二·选择性必修）：强碱弱酸盐中，阳离子浓度最大，酸根离子因水解稍减少。'},{text:'c(Na⁺)>c(OH⁻)>c(CO₃²⁻)>c(H⁺)',correct:false},{text:'c(CO₃²⁻)>c(Na⁺)>c(OH⁻)>c(H⁺)',correct:false},{text:'c(Na⁺)=2c(CO₃²⁻)',correct:false}] },
    ...
    // --- 农民·高三补充 ---
    QUESTIONS.farmer.cyberpunk.push(
        { grade:'高三', subject:'化学', text:'氢氧化铁的Ksp=4.0×10⁻³⁸。某溶液中c(Fe³⁺)=0.01mol/L，开始沉淀Fe(OH)₃的pH约为？（lg2=0.3）', choices:[{text:'pH≈2.2——Ksp=[Fe³⁺][OH⁻]³, [OH⁻]=∛(Ksp/[Fe³⁺])=∛(4.0×10⁻³⁶)≈1.6×10⁻¹², pOH≈11.8, pH≈2.2',correct:true,knowledge:'化学·沉淀溶解平衡（高三·等级考）：Ksp=[Fe³⁺][OH⁻]³，利用Ksp计算开始沉淀的pH。'},{text:'pH≈7',correct:false},{text:'pH≈10',correct:false},{text:'pH≈5',correct:false}] }
    );
    ...
    // --- 记者·高二补充 ---
    QUESTIONS.journalist.history.push(
        { grade:'高二', subject:'英语', text:'"If I ________ you, I would accept the offer." The correct verb form is:', choices:[{text:'were — 虚拟语气中与现在事实相反，be动词一律用were',correct:true,knowledge:'英语·虚拟语气（高二·语法重点）：与现在事实相反的假设，条件句用动词过去式(be用were)，主句用would+动词原形。'},{text:'was',correct:false},{text:'am',correct:false},{text:'had been',correct:false}] }
    );

    // --- 记者·高三补充 ---
    QUESTIONS.journalist.modern.push(
        { grade:'高三', subject:'语文', text:'以下关于《红楼梦》中人物判词的描述，正确的是？', choices:[{text:'"可叹停机德，堪怜咏絮才。玉带林中挂，金簪雪里埋"——前两句分别指薛宝钗（停机德）和林黛玉（咏絮才），后两句暗示二人命运',correct:true,knowledge:'语文·整本书阅读（高三·高考）：《红楼梦》第五回金陵十二钗判词，是理解全书人物命运的关键。'},{text:'"可叹停机德"指的是王熙凤',correct:false},{text:'"玉带林中挂"指的是贾探春',correct:false},{text:'判词是《红楼梦》第一回的内容',correct:false}] }
    );

    // --- 医生·高一补充 ---
    QUESTIONS.doctor.history.push(
        { grade:'高一', subject:'生物', text:'人体血液中葡萄糖的正常浓度约为0.1%。从细胞角度，葡萄糖进入红细胞的方式是？', choices:[{text:'协助扩散——葡萄糖通过载体蛋白顺浓度梯度进入红细胞，不消耗能量',correct:true,knowledge:'生物·物质跨膜运输（高一·必修1）：协助扩散不消耗ATP，依赖载体蛋白，顺浓度梯度。主动运输消耗ATP。'},{text:'自由扩散',correct:false},{text:'主动运输',correct:false},{text:'胞吞作用',correct:false}] }
    );
    QUESTIONS.doctor.modern.push(
        { grade:'高一', subject:'地理', text:'你在中国某地建立了一座野战医院。该地夏季高温多雨、冬季温和少雨，植被为亚热带常绿阔叶林。该地气候类型是？', choices:[{text:'亚热带季风气候——中国秦岭-淮河以南的典型气候，上海即属此类',correct:true,knowledge:'地理·中国气候类型（高一·必修1）：亚热带季风气候夏季高温多雨(东南季风)，冬季温和少雨(西北季风)。'},{text:'温带季风气候',correct:false},{text:'热带季风气候',correct:false},{text:'温带大陆性气候',correct:false}] }
    );

    // --- 医生·高二补充 ---
    QUESTIONS.doctor.history.push(
        { grade:'高二', subject:'生物', text:'DNA复制时，新的DNA链是以什么方向合成的？', choices:[{text:'5\'→3\'方向——DNA聚合酶只能从5\'端向3\'端延伸新链',correct:true,knowledge:'生物·DNA复制（高二·必修2）：DNA双链反向平行，复制时前导链连续合成，后随链不连续（冈崎片段）。'},{text:'3\'→5\'方向',correct:false},{text:'两个方向都可以',correct:false},{text:'没有固定方向',correct:false}] }
    );

    // --- 医生·高三补充 ---
    QUESTIONS.doctor.cyberpunk.push(
        { grade:'高三', subject:'生物', text:'某蛋白质由200个氨基酸组成（含2条肽链），合成过程中脱去的水分子数是多少？', choices:[{text:'198个——脱水数=氨基酸数-肽链数=200-2=198',correct:true,knowledge:'生物·蛋白质合成（高三·等级考）：n个氨基酸形成m条肽链，脱去(n-m)个水分子，形成(n-m)个肽键。'},{text:'200个',correct:false},{text:'199个',correct:false},{text:'196个',correct:false}] }
    );

    // --- 程序员·高一补充 ---
    QUESTIONS.programmer.history.push(
        { grade:'高一', subject:'信息科技', text:'以下Python代码：<br><code>for i in range(1, 6):\n    if i==3: continue\n    print(i, end=" ")</code><br>输出结果是什么？', choices:[{text:'1 2 4 5——continue跳过本次循环剩余语句，3不被打印',correct:true,knowledge:'信息科技·Python循环控制（高一·必修1）：continue跳过当前迭代；break退出整个循环。range(1,6)生成1~5。'},{text:'1 2 3 4 5',correct:false},{text:'1 2',correct:false},{text:'1 2 4 5 6',correct:false}] }
    );
    ...
    // --- 程序员·高二补充 ---
    QUESTIONS.programmer.modern.push(
        { grade:'高二', subject:'信息科技', text:'有一个栈（Stack），依次执行 push(1), push(2), pop(), push(3), pop(), pop()。栈的弹出序列是？', choices:[{text:'2, 3, 1——栈是后进先出(LIFO)结构',correct:true,knowledge:'信息科技·数据结构（高二·选择性必修）：栈(stack)=后进先出(LIFO)。push(1,2)→[1,2], pop→出2, push(3)→[1,3], pop→出3, pop→出1。'},{text:'1, 2, 3',correct:false},{text:'2, 1, 3',correct:false},{text:'1, 3, 2',correct:false}] }
    );

    // --- 程序员·高三补充 ---
    QUESTIONS.programmer.cyberpunk.push(
        { grade:'高三', subject:'信息科技', text:'一个长度为n的有序数组，使用二分查找(Binary Search)算法，最坏情况下的时间复杂度是？', choices:[{text:'O(log n)——每次查找将搜索范围缩小一半',correct:true,knowledge:'信息科技·算法复杂度（高三·等级考）：二分查找每步比较将区间减半，最坏比较次数为⌈log₂(n+1)⌉。'},{text:'O(n)',correct:false},{text:'O(n²)',correct:false},{text:'O(1)',correct:false}] }
    );

    // --- 工程师·高一补充 ---
    QUESTIONS.engineer.history.push(
        { grade:'高一', subject:'物理', text:'一辆重2吨的卡车以36km/h的速度行驶，其动能是多少？', choices:[{text:'100000J——v=10m/s, Ek=½mv²=½×2000×100=100000J',correct:true,knowledge:'物理·动能（高一·必修2）：Ek=½mv²，注意单位换算36km/h=36000/3600=10m/s。'},{text:'50000J',correct:false},{text:'200000J',correct:false},{text:'10000J',correct:false}] }
    );
    QUESTIONS.engineer.modern.push(
        { grade:'高一', subject:'数学', text:'若集合A={x|x²-5x+6=0}，则集合A中的元素是？', choices:[{text:'{2,3}——解方程x²-5x+6=0得(x-2)(x-3)=0，x=2或x=3',correct:true,knowledge:'数学·集合（高一·必修1）：一元二次方程的根构成集合。集合表示法：列举法{2,3}。'},{text:'{1,6}',correct:false},{text:'{1,5}',correct:false},{text:'{-2,-3}',correct:false}] }
    );

    // --- 工程师·高二补充 ---
    QUESTIONS.engineer.history.push(
        { grade:'高二', subject:'物理', text:'一根导线在匀强磁场中以速度v做切割磁力线运动。产生感应电动势的大小取决于？', choices:[{text:'磁感应强度B、导线长度L、速度v及B与v的夹角——E=BLv·sinθ',correct:true,knowledge:'物理·电磁感应（高二·选择性必修）：导体切割磁力线产生的感应电动势E=BLv·sinθ，方向由右手定则判定。'},{text:'只取决于磁感应强度B',correct:false},{text:'只取决于导线运动速度v',correct:false},{text:'只取决于导线长度L',correct:false}] }
    );

    // --- 工程师·高三补充 ---
    QUESTIONS.engineer.cyberpunk.push(
        { grade:'高三', subject:'数学', text:'lim(x→0) sin(3x)/x 的值为？', choices:[{text:'3——lim(x→0) sin(ax)/x=a，利用重要极限lim(x→0) sinx/x=1',correct:true,knowledge:'数学·极限（高三·高考复习）：重要极限lim(x→0) sinx/x=1的推广。sin(3x)/x=3·sin(3x)/(3x)→3×1=3。'},{text:'1',correct:false},{text:'0',correct:false},{text:'1/3',correct:false}] },
        { grade:'高三', subject:'物理', text:'某放射性元素半衰期为5天。经过15天后，剩余的质量是原来的几分之几？', choices:[{text:'1/8——15天=3个半衰期，每次衰减一半：(½)³=1/8',correct:true,knowledge:'物理·原子核物理（高三·等级考）：半衰期T½，经过nT½后剩余量为初始的(½)ⁿ。'},{text:'1/3',correct:false},{text:'1/6',correct:false},{text:'1/4',correct:false}] }
    );
}
...
var ERA_EMOJI = ['📜', '🌐', '🤖'];
var ERA_YEARS = ['1950s-1970s', '1990s-2010s', '2080s'];
...
function renderChoices(q) {
    ...
    q.choices.forEach(function(choice, i) {
        ...
        btn.textContent = getLabel(i) + '. ' + choice.text;
        btn.addEventListener('click', function() {
            if (answered) return;
            if (!isMulti) {
                // 单选：切换选中状态
